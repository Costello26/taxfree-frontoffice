...
export const globalLocales = {
  ...
  stats: {
    ...
    phoneLabel: ['Номер телефона', 'Telefon raqami', 'Phone number'],
    yearLabel: ['Год', 'Yil', 'Year'],
    monthLabel: ['Месяц', 'Oy', 'Month'],
    dayLabel: ['День', 'Kun', 'Day'],
    table: {
      fio: ['ФИО', 'FISh', ''],
      phone: ['Номер телефона', 'Telefon raqami', 'Phone number'],
      card: ['Номер карты', 'Karta raqami', 'Card number'],
      productPrice: ['Стоимость товара', 'Mahsulot narxi', 'Product price'],
      count: ['Количество', 'Tovarlar soni', 'Сount'],
      status: ['Статус', 'Holati', 'Status'],
    },
  },
  checkPrint: {
  ...
  header: {
    pinfl: ['ПИНФЛ:', 'JShShIR:', 'PINI'],
  },
  footer: {
    help: ['Помощь и поддержка', "Yordam va qo'llab-quvvatlash", 'Help&Support'],
    copyright: [

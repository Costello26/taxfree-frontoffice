...
function GetPropertyValue(propertyName, successFunction) {
  Get(
    serviceUrl + '/Settings/GetPropertyValue?propertyName=' + propertyName,
    successFunction
  );
}
...
function SetPropertyValue(propertyName, value, successFunction) {
  Post(
    serviceUrl + '/Settings/SetPropertyValue?propertyName=' + propertyName,
    successFunction,
    value
  );
}
...
function CheckRFIDResultXML(type, output, successFunction) {
  Get(
    serviceUrl + '/Methods/CheckRFIDResultXML?AType=' + type + '&AOutput=' + output,
    successFunction
  );
}
...
function get_AvailableGraphicFormats(index, successFunction) {
  Get(
    serviceUrl + '/Methods/get_AvailableGraphicFormats?Index=' + index,
    successFunction
  );
}
...
function GetReaderBitmapImageByLightIndex(light, successFunction) {
  Get(
    serviceUrl + '/Methods/GetReaderBitmapImageByLightIndex?ALight=' + light,
    successFunction
  );
}
...
function GetReaderEOSBitmapImageByLightIndex(light, successFunction) {
  Get(
    serviceUrl + '/Methods/GetReaderEOSBitmapImageByLightIndex?ALight=' + light,
    successFunction
  );
}
...
function GetReaderFileImageByLightIndex(light, successFunction) {
  Get(
    serviceUrl + '/Methods/GetReaderFileImageByLightIndex?ALight=' + light,
    successFunction
  );
}
...
function GetReaderGraphicsBitmapByFieldType(type, successFunction) {
  Get(
    serviceUrl + '/Methods/GetReaderGraphicsBitmapByFieldType?AType=' + type,
    successFunction
  );
}
...
function GetReaderGraphicsFileImageByFieldType(type, successFunction) {
  Get(
    serviceUrl + '/Methods/GetReaderGraphicsFileImageByFieldType?AType=' + type,
    successFunction
  );
}
...
function GetRFIDGraphicsBitmapByFieldType(type, successFunction) {
  Get(
    serviceUrl + '/Methods/GetRFIDGraphicsBitmapByFieldType?AType=' + type,
    successFunction
  );
}
...
function GetRFIDGraphicsFileImageByFieldType(type, successFunction) {
  Get(
    serviceUrl + '/Methods/GetRFIDGraphicsFileImageByFieldType?AType=' + type,
    successFunction
  );
}
...
function GetSnapshot(light, mode, successFunction) {
  Get(
    serviceUrl + '/Methods/GetSnapshot?ALight=' + light + '&AMode=' + mode,
    successFunction
  );
}
...
function CheckReaderResultJSON(type, index, output, successFunction) {
  Get(
    serviceUrl +
...
function CheckRFIDResultJSON(type, output, successFunction) {
  Get(
    serviceUrl + '/Methods/CheckRFIDResultJSON?AType=' + type + '&AOutput=' + output,
    successFunction
  );
}
...
function AppendPortrait(image, format, type, successFunction) {
  ...
  Post(
    serviceUrl + '/Methods/AppendPortrait?AFormat=' + format + '&AType=' + type,
    successFunction,
    img
  );
}
...
function AppendPortrait(filename, type, successFunction) {
  Post(
    serviceUrl + '/Methods/AppendPortraitFromFile?AType=' + type,
    successFunction,
    filename
  );
}
...
function AppendRFIDDataFromFile(filename, type, successFunction) {
  Post(
    serviceUrl + '/Methods/AppendRFIDDataFromFile?AType=' + type,
    successFunction,
    filename
  );
}
...
function initRegulaReader(url, isFallback) {
  ...
  if (isFallback) signalRUrl += 'notifications';
      ...
      if (xhr.status == 200) {
        $.getScript(serviceUrl + '/signalR.min.js', function (data) {
          ...
          hubProxy.on('OnExtPortraitRequest', function () {
            if (OnExtPortraitRequestCallback != null) OnExtPortraitRequestCallback();
...
function Get(url, successFunction) {
  ...
  if (urlP) {
    ...
    for (var i = 0; i < entries.length; i++) urlArgs.push(entries[i][1]);
  }

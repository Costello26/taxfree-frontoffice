(function () {
    ...
    unmarshallSingle = function (data, escapeHeaderValues) {
      ...
      for (j = 0, len1 = ref.length; j < len1; j++) {
        ...
        if (escapeHeaderValues && command !== 'CONNECT' && command !== 'CONNECTED') {
          headers[trim(line.substring(0, idx))] = Frame.frUnEscape(
      ...
      if (headers['content-length']) {
        ...
        chr = null;
        for (
          i = k = ref1 = start, ref2 = data.length;
  ...
  Client = (function () {
    ...
    Client.prototype._setupHeartbeat = function (headers) {
      ...
      if (
        (ref = headers.version) !== Stomp.VERSIONS.V1_1 &&
        ref !== Stomp.VERSIONS.V1_2
      ) {
        return;
      }
      (ref1 = (function () {
        ...
        (serverOutgoing = ref1[0]),
        (serverIncoming = ref1[1]);
    ...
    Client.prototype.connect = function () {
      ...
      (this.headers = out[0]),
        ...
        (this.errorCallback = out[2]),
        (this.closeEventCallback = out[3]);
      this._active = true;
    ...
    Client.prototype.disconnect = function (disconnectCallback, headers) {
      ...
      if (this.connected) {
        ...
        try {
          ...
          error = error1;
          return typeof this.debug === 'function'
